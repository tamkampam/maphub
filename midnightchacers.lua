            ...
            for _, otherPlayer in pairs(players) do
                if otherPlayer ~= Player and otherPlayer.Character then
                    ...
                    if humanoidRootPart then
                        ...
                        local distanceToPlayer = (playerPosition - Player.Character.HumanoidRootPart.Position).Magnitude
                        
                        print("BOT: " .. otherPlayer.Name .. " - Distance to target: " .. math.floor(distanceToTarget) .. " studs, Distance to me: " .. math.floor(distanceToPlayer) .. " studs")
